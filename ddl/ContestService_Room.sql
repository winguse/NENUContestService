...
CREATE TABLE `Room` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Room_Hotel1` (`Hotel`),
  CONSTRAINT `fk_Room_Hotel1` FOREIGN KEY (`Hotel`) REFERENCES `Hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2012-09-19  7:00:34
